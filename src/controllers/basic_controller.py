...
class BasicMAC:
    ...
    def _build_agents(self, input_shape, hidden_shape=None):
        if hidden_shape is None:
            self.agent = agent_REGISTRY[self.args.agent](input_shape,  self.args)
        else:
            self.agent = agent_REGISTRY[self.args.agent](input_shape, hidden_shape, self.args)
