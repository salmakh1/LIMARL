...
def run_sequential(args, logger):
    ...
    while runner.t_env <= args.t_max:
        ...
        if off_buffer.can_sample(args.buffer_size):
            ...
            if args.learner == "vae_nq_learner" or args.learner == "rvae_nq_learner" or args.learner == "rvae_q_learner" or args.learner == "world_nq_learner" or args.learner == "world_nq_learner_updated" or args.learner == "owm_nq_learner" or args.learner == "rvae_dmaq_qatten_learner" or args.learner == "rvae_fmac_learner":
                learner.train(episode_sample, runner.t_env, episode, off=False, buffer=on_buffer)
            else:
